# Lista completa dos municipios de Minas Gerais
MUNICIPIOS_MG = [
    "Abadia dos Dourados",
    "Abaete",
    "Abre Campo",
...
PADRAO = [
    ...
    "Planura",
    "Sao Simao",
]  # 304 kVA trifásico / 50 kVA monofásico - Urbano/Rural
CIDADE_100_25 = [
    "Itapecerica",
    "Pedra do Indaia",
    "Sao Sebastiao do Oeste",
]  # 100 kVA trifásico / 25 kVA monofásico - Rural
CIDADE_50_50 = [
    "Tres Marias",
    "Jequitai",
    "Pirapora",
    ...
    "Uruana de Minas",
    "Urucuia",
]  # 50 kVA trifásico / 50 kVA monofásico - Rural
DEMAIS = ""  # 100 kVA trifásico / 50 kVA monofásico - Urbano/Rural
